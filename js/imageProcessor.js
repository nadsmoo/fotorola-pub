...
export const imageProcessor = {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                img.onload = async () => {
                    ...
                    // Convert byte array back to URL for cropping
                    const blob = new Blob([shrunkenImageData]);
    ...
    getImageUrlFromCanvas: async function (canvas) {
        return new Promise((resolve, reject) => {
            try {
                ...
                // Convert to data URL (base64 encoded, works everywhere)
    ...
    placeImageOnCanvas: async function (canvas, imageUrl, x, y) {
        ...
        return new Promise((resolve, reject) => {
            ...
            img.onload = () => {
                // Draw the image at the exact x,y coordinates specified (no multiplication)
                ctx.drawImage(img, x, y);
                console.log(`Image placed at x:${x}, y:${y}, image size: ${img.width}x${img.height}`);
                resolve();
            };
